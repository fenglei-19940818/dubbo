...
<body>
    ...
    <!-- 数据表格 -->
    <table class="table" id="memberrank-table"></table>

    <script type="text/javascript">

        $(function () {
            $("#memberrank-table").bootstrapTable({
                url:"<%=request.getContextPath()%>/memberRank/queryMemberRankListPager.jhtml",
                striped: true,//隔行变色
        ...
        function addMemberRank() {
            //跳转添加页面
            location.href="<%=request.getContextPath()%>/memberRank/toaddMemberRank.jhtml";
        }
        ...
        function deleteMemberRank() {
            ...
            if(a){
                $.ajax({
                    url:"<%=request.getContextPath()%>/memberRank/deleteMemberRank.jhtml",
                    type:"post",
                    data:{"ids":ids},
