...
<div class="path">
    ...
    <script type="text/javascript">
        ...
        $(function(){
            //页面刷新，根据id查询
            $.ajax({
                url:"<%=request.getContextPath()%>/memberAttribute/queryMemberAttributeByid.jhtml",
                type:"post",
                data:{"id":$("[name='id']").val()},
        ...
        function updateMemberAttribute() {
            ...
            //修改
            $.ajax({
                url:"<%=request.getContextPath()%>/memberAttribute/updateMemberAttribute.jhtml",
                type:"post",
                data:$("#updateMemberAttribute-form").serialize(),//将表单序列化为key value的形式
                dataType:"text",//json   text
                success:function (msg){
                    if(msg==1){
                        location.href="<%=request.getContextPath()%>/memberAttribute/toShowMemberAttribute.jhtml";
                    }else{
                        alert("添加失败");
                    }
                },
