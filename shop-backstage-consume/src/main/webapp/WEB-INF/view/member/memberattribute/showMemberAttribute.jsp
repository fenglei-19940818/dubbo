    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#memberattribute-table").bootstrapTable({
                url:"<%=request.getContextPath()%>/memberAttribute/queryMemberAttributeListPager.jhtml",
                striped: true,//隔行变色
...
//                            }
        ...
        function addMemberAttribute() {
            location.href="<%=request.getContextPath()%>/memberAttribute/toaddMemberAttribute.jhtml";
        }

        //跳转修改页面
        function updatememberAttribute(id) {
            location.href="<%=request.getContextPath()%>/memberAttribute/toupdateMemberAttribute.jhtml?id="+id;
        }
        ...
        function deleteMemberAttribute() {
            ...
            if(a){
                $.ajax({
                    url:"<%=request.getContextPath()%>/memberAttribute/deleteMemberAttribute.jhtml",
                    type:"post",
                    data:{"ids":ids},
